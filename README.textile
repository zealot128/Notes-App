...
Also, this was a great opportunity to test the new Rails 3.1 Features, like assets, integration with compasse etc.
...
* **tumblr-like** Bookmarklet for fast-reblogging of content, of course, inspired through this
* Rails 3.1 with compass and coffeescript.
* facebook, google plus and twitter social buttons with 2-click strategy, to adhere German data privacy law, powered bei heise.de


h2. TODO

* Installation of wkhtml needs some description but is pretty easy actually
* Installation needs an admin user
